...
module soc_system_mm_interconnect_1 (
		...
		output wire [3:0]  onchip_memory2_1_s1_address,                            //                              onchip_memory2_1_s1.address
	...
	wire  [107:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // button_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [10:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire   [10:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [108:0] onchip_memory2_1_s1_agent_rf_source_data;                                   // onchip_memory2_1_s1_agent:rf_source_data -> onchip_memory2_1_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] onchip_memory2_1_s1_agent_rsp_fifo_out_data;                                // onchip_memory2_1_s1_agent_rsp_fifo:out_data -> onchip_memory2_1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_009_src_valid;                                                      // cmd_mux_009:src_valid -> onchip_memory2_1_s1_agent:cp_valid
	wire  [107:0] cmd_mux_009_src_data;                                                       // cmd_mux_009:src_data -> onchip_memory2_1_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                      // onchip_memory2_1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                    // cmd_mux_009:src_channel -> onchip_memory2_1_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                              // cmd_mux_009:src_startofpacket -> onchip_memory2_1_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                // cmd_mux_009:src_endofpacket -> onchip_memory2_1_s1_agent:cp_endofpacket
	...
	wire  [107:0] cmd_mux_010_src_data;                                                       // cmd_mux_010:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [107:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [107:0] uart_0_s1_agent_rp_data;                                                    // uart_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [89:0] onchip_memory2_0_s1_agent_rp_data;                                          // onchip_memory2_0_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [107:0] onchip_memory2_1_s1_agent_rp_data;                                          // onchip_memory2_1_s1_agent:rp_data -> router_011:sink_data
	...
	wire   [89:0] onchip_memory2_0_s1_burst_adapter_source0_data;                             // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [107:0] cmd_demux_001_src8_data;                                                    // cmd_demux_001:src8_data -> cmd_mux_010:sink1_data
	wire          cmd_demux_001_src8_ready;                                                   // cmd_mux_010:sink1_ready -> cmd_demux_001:src8_ready
	wire   [10:0] cmd_demux_001_src8_channel;                                                 // cmd_demux_001:src8_channel -> cmd_mux_010:sink1_channel
	...
	wire  [107:0] rsp_demux_010_src1_data;                                                    // rsp_demux_010:src1_data -> rsp_mux_001:sink8_data
	wire          rsp_demux_010_src1_ready;                                                   // rsp_mux_001:sink8_ready -> rsp_demux_010:src1_ready
	wire   [10:0] rsp_demux_010_src1_channel;                                                 // rsp_demux_010:src1_channel -> rsp_mux_001:sink8_channel
	...
	wire   [89:0] router_010_src_data;                                                        // router_010:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	wire          router_010_src_ready;                                                       // onchip_memory2_0_s1_rsp_width_adapter:in_ready -> router_010:src_ready
	wire   [10:0] router_010_src_channel;                                                     // router_010:src_channel -> onchip_memory2_0_s1_rsp_width_adapter:in_channel
	...
	wire  [107:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                             // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_008:sink_data
	...
	wire   [10:0] onchip_memory2_0_s1_rsp_width_adapter_src_channel;                          // onchip_memory2_0_s1_rsp_width_adapter:out_channel -> rsp_demux_008:sink_channel
	...
	wire  [107:0] cmd_mux_008_src_data;                                                       // cmd_mux_008:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_008_src_ready;                                                      // onchip_memory2_0_s1_cmd_width_adapter:in_ready -> cmd_mux_008:src_ready
	wire   [10:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> onchip_memory2_0_s1_cmd_width_adapter:in_channel
	...
	wire   [89:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                             // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire   [10:0] onchip_memory2_0_s1_cmd_width_adapter_src_channel;                          // onchip_memory2_0_s1_cmd_width_adapter:out_channel -> onchip_memory2_0_s1_burst_adapter:sink0_channel
	...
	wire   [17:0] onchip_memory2_0_s1_agent_rdata_fifo_src_data;                              // onchip_memory2_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	...
	wire   [17:0] avalon_st_adapter_008_out_0_data;                                           // avalon_st_adapter_008:out_0_data -> onchip_memory2_0_s1_agent:rdata_fifo_sink_data
	...
	wire          onchip_memory2_1_s1_agent_rdata_fifo_src_valid;                             // onchip_memory2_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] onchip_memory2_1_s1_agent_rdata_fifo_src_data;                              // onchip_memory2_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          onchip_memory2_1_s1_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_009:in_0_ready -> onchip_memory2_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                          // avalon_st_adapter_009:out_0_valid -> onchip_memory2_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                           // avalon_st_adapter_009:out_0_data -> onchip_memory2_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                          // onchip_memory2_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                          // avalon_st_adapter_009:out_0_error -> onchip_memory2_1_s1_agent:rdata_fifo_sink_error
	...
	soc_system_mm_interconnect_1_cmd_mux_008 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_cmd_mux_008 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_008 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_008 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_008 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
